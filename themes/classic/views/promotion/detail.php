				...
				<div class="menu-left-inscontent">
					<ul>
						<?php foreach ($data as $key => $value): ?>
							<li><a href="<?php echo CHtml::normalizeUrl(array('/promotion/detail', 'id'=>$value->id, 'url'=>Slug::create($value->title))); ?>">
					...
					<div class="item">
						<div class="row">
							<div class="col-xs-5 w311">
								<div class="pic"><a href="<?php echo CHtml::normalizeUrl(array('/promotion/detail', 'id'=>$detail->id, 'url'=>Slug::create($detail->title), 'lang'=>Yii::app()->language)); ?>">
									<img src="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(277,187, '/images/promotion/'.$detail->image , array('method' => 'adaptiveResize', 'quality' => '90')) ?>" alt="">
								</a></div>
							</div>
							<div class="col-xs-7 w528">
								<div class="title text-gothic"><a href="<?php echo CHtml::normalizeUrl(array('/promotion/detail', 'id'=>$detail->id, 'url'=>Slug::create($detail->title), 'lang'=>Yii::app()->language)); ?>"><?php echo $detail->title ?></a></div>
