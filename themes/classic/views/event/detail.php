	...
	<div class="prelatif container">
			...
			<div class="region inside-content prelatif">
							...
							<ul>
								...
								<li><a href="<?php echo CHtml::normalizeUrl(array('event/index', 'year'=>$key, 'month'=>$k, 'lang'=>Yii::app()->language)); ?>"><?php echo Yii::app()->locale->getMonthName($k) ?> <?php echo $key ?></a>
									<ul>
										...
										<li <?php if ($val->id == $_GET['id']): ?>class="active"<?php endif ?>><a href="<?php echo CHtml::normalizeUrl(array('/event/detail', 'id'=>$val->id, 'slug'=>Slug::create($val->title), 'lang'=>Yii::app()->language)); ?>"><?php echo $val->title ?></a></li>
										<?php endforeach ?>
									</ul>
								</li>
				...
				<div class="left right-content">
						...
						<div class="right breadcumb">
							<a href="<?php echo CHtml::normalizeUrl(array('home/index', 'lang'=>Yii::app()->language)); ?>"><?php echo Yii::t('main', 'home') ?></a> &gt; 
							<a href="<?php echo CHtml::normalizeUrl(array('event/index', 'lang'=>Yii::app()->language)); ?>"><?php echo Yii::t('main', 'event gallery') ?></a> &gt; 
							<b><?php echo $detail->title ?></b>
						</div>
						<div class="clear height-25"></div>
						<div class="content-text">
							<h5><?php echo $detail->title ?></h5>
							<?php echo Common::replaceBr(nl2br($detail->content)) ?>
							
							<div class="clear height-10"></div>
							<div class="list-gallery">
								<div class="row">
									<?php foreach ($detail->galleryPhotos as $k => $v): ?>
									<div class="col-xs-3">
										<div class="item">
											<a class="fancybox" rel="gallery-0" href="<?php echo Yii::app()->baseUrl.ImageHelper::thumb(640,640, '/images/gallery/'.$v->rank.'.jpg' , array('method' => 'resize', 'quality' => '90')) ?>">
...
<script type="text/javascript">
	...
	$('.menu-inside li ul li.active').parent().show();
