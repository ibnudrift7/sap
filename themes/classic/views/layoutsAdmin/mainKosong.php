...
<head>
    ...
    <script type="text/javascript" src="<?php echo Yii::app()->baseUrl; ?>/asset/js/jquery.min.js"></script>  
    <script type="text/javascript" src="<?php echo Yii::app()->baseUrl; ?>/asset/js/all.js"></script>  
