<div class="leftmenu">        
    <ul class="nav nav-tabs nav-stacked">
        ...
        <li class="dropdown"><a href="#"><span class="fa fa-folder"></span> <?php echo Tt::t('admin', 'Markets') ?></a>
            <ul>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/filtercat/index')); ?>">Category</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/brand/index')); ?>">Data Market</a></li>
            </ul>
        </li>
        ...
        */ ?>
        ...
        <li class="dropdown"><a href="#"><span class="fa fa-folder"></span> <?php echo Tt::t('admin', 'Solution') ?></a>
            <ul>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/studio')); ?>">Suryasukses Studio</a></li>
                <li><a href="<?php echo CHtml::normalizeUrl(array('/admin/static/capabilities')); ?>">Capabilities</a></li>
            </ul>
        </li>
