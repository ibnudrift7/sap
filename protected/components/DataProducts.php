        ...
        $data = [
                    ...
                    [
                        ...
                        'lists' => [
                                        [
                                            'names'=>'preform',
                                            'picture'=>['preform001.jpg','preform002.jpg'],
                                        ...
                                        [
                                            'names'=>'bottles',
                                            'picture'=>['bottle001.jpg','bottle002.jpg'],
                                        ...
                                        [
                                            'names'=>'drinking cups',
                                            'picture'=>['drinking-cups001.jpg','drinking-cups002.jpg'],
                                            'info'=>'<p>At Surya Sukses Group, we produce any kind and variety of cups, they are souvenir cups, disposable cups, and other food related cups, along with printing process to suit your needs.</p>
                                            <p>To view more detailed product information, please visit:<br><a target="_blank" href="http://www.botolplastik.id">www.botolplastik.id</a></p>',
                                        ],
                                        [
                                            'names'=>'lids',
                                            'picture'=>['lids001.jpg'],
                    ...
                    // speciality nonwoven
                    [
                        'name_category'=>'specialty nonwoven',
                        'picture'=>['cover-specialty.jpg'],
                        'desc'=>'<p>Our nonwoven fabric solutions are produced on unique and world-leading technology. Through partnership and innovation we deliver value and differentiation for our customers.</p>',
                        'lists' => [
                                        [
                                            'names'=>'spunbond polypropylene',
                                            'picture'=>['spubond-polypropylene.jpg'],
                                            'info'=>'<p>Surya Sukses Group is catering the needs of economic yet durable on performance spunbond fabric – made from polypropylene. Unlike the usual nonwoven fabric, Surya Sukses Group’s nonwoven material quality is felt instantly when you touch it, we will exceed your expectations.</p>',
                                        ],
                                        [
                                            'names'=>'meltblown',
                                            'picture'=>['meltblown-001.jpg','meltblown-002.jpg'],
                                            'info'=>'<p>Our meltblown nonwoven products are formed from micro fibers that are smaller than those found in other nonwovens or textiles made by other manufacturer. The smooth silky surface texture and the elegant round cross-section provide a high surface area for excellent insulation, softness, and filtration characteristics. Custom-laminated meltblown composites can also be manufactured upon request.</p>',
                                        ],
                    ...
                    [
                        ...
                        'lists' => [
                                        ...
                                        [
                                            ...
                                            'info'=>'<p>Your garden and plants will become more attractive with a complete collection of garden plastic products from Surya Sukses Group.</p>',
                                        ],   
                                    ],
                    ],
                    // roofing
                    [
                        ...
                        'picture'=>['cover-roofing-suryasukses.jpg'],
                        'desc'=>'',
                        'lists' => [
                                        [
